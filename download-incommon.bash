...
# these are the intermediates InCommon and USERTrust
# this does not include the unnecessary root CA AddTrust
#
# WARNING: this will break when these certificates expire
# and the new intermediates will need to be replaced here.
echo -n '
-----BEGIN CERTIFICATE-----
